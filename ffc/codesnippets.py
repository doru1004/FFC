...
ufc_facet_determinant = {1: {1: _facet_determinant_1D},
                         2: {2: _ufc_facet_determinant_2D, 1: _facet_determinant_2D_1D},
                         3: {3: _ufc_facet_determinant_3D, 2: _facet_determinant_3D_2D,
                             1: _facet_determinant_3D_1D}}

pyop2_facet_determinant = {1: {1: _facet_determinant_1D},
                           2: {2: _pyop2_facet_determinant_2D, 1: _facet_determinant_2D_1D},
                           3: {3: _pyop2_facet_determinant_3D, 2: _facet_determinant_3D_2D,
                               1: _facet_determinant_3D_1D}}
