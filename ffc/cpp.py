...
format.update({
    ...
    "generate normal":          {"ufc": lambda tdim, gdim, i: _generate_normal(tdim, gdim, i, ufc_normal_direction),
                                 "pyop2": lambda tdim, gdim, i: _generate_normal(tdim, gdim, i, pyop2_normal_direction)},
...
def _generate_normal(tdim, gdim, domain_type, normal_direction, reference_normal=False):
